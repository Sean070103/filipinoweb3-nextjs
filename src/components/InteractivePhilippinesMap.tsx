...
const communityLocations: CommunityLocation[] = [
  ...
  },
  {
    ...
    description:
      "Web3 Bacolod is a local community of blockchain & Web3 enthusiasts based in Bacolod City & the Negros Island Region.",
  ...
  },
  {
    name: "Aklan",
    region: "Visayas",
    coordinates: [11.674253, 122.280862],
    avatar: "/images/community_aklan.jpg",
  },
  {
    name: "Guimaras",
    region: "Visayas",
    coordinates: [10.580708, 122.612946],
    avatar: "/images/community_guimaras.jpg",
  },
  {
    name: "Leyte",
    region: "Visayas",
    coordinates: [11.357256, 124.496108],
    avatar: "/images/community_leyte.jpg",
  },
  {
    name: "Ilocos",
    region: "Luzon",
    coordinates: [17.849203, 120.554178],
    avatar: "/images/community_ilocos.jpg",
  },
  {
    name: "Dumaguete",
    region: "Visayas",
    coordinates: [9.303834, 123.303175],
    avatar: "/images/community_dumaguete.jpg",
  },
  {
    name: "Davao",
    region: "Mindanao",
    coordinates: [7.064605, 125.608773],
    avatar: "/images/community_davao.jpg",
  },
  {
    name: "Pangasinan",
    region: "Luzon",
    coordinates: [16.003085, 120.321961],
    avatar: "/images/community_pangasinan.jpg",
  },
  {
    name: "Bulacan",
    region: "Luzon",
    coordinates: [14.860018, 120.906407],
    avatar: "/images/community_bulacan.jpg",
  },
  {
...
const createCustomIcon = (
  ...
  region: CommunityLocation["region"],
  isSelected: boolean,
  isHovered: boolean,
) => {
    ...
    html: `
      ...
      ">
        ...
        <div style="
          ...
          border-radius: 50%;
          background: ${
            isSelected ? "linear-gradient(135deg, #22d3ee, #a855f7)" : color
          };
...
export default function InteractivePhilippinesMap() {
  ...
  useEffect(() => {
    ...
    const map = L.map(mapContainerRef.current, {
      ...
      maxZoom: isMobile ? 12 : 13, // Increased max zoom to allow proper zooming
      dragging: true, // Enable dragging for better UX
    ...
    fetch(
      ...
      .then((worldData) => {
        ...
        if (philippines) {
          ...
          // Add hover effect
          geoJsonLayer.on("mouseover", function (e: LeafletMouseEvent) {
          ...
          map.fitBounds(geoJsonLayer.getBounds().pad(padding[0]), { padding });
        }
      })
      .catch(() => {
        ...
        fetch(
          ...
          .then((worldData) => {
            ...
            if (philippines) {
              ...
              const padding: [number, number] = isMobile
    ...
    communityLocations.forEach((location) => {
      ...
      const marker = L.marker(location.coordinates, { icon })
        ...
        .on("click", () => {
          ...
          if (geoJsonLayerRef.current) {
            ...
            const regionGlow = getRegionGlowColor(
      ...
      const memberNames = membersInCity
        .map((loc) => {
      ...
      marker.bindPopup(
        ...
        ">
          ...
          ">
            <span style="color: #22d3ee; font-size: ${
          ...
          <div style="
            ...
            margin-bottom: ${
              location.avatar ? (isMobile ? "0.35rem" : "0.5rem") : "0"
            };
            color: #a855f7;
          ">${location.region}</div>
          ${
    ...
    if (markersRef.current.length > 0) {
      ...
      map.fitBounds(bounds.pad(padAmount));
    }
  ...
  useEffect(() => {
    ...
    if (!selectedLocation) {
      ...
      const regionGlow = getRegionGlowColor(
        selectedLocation.region as Region,
        0.6,
      );
      ...
      if (mapRef.current) {
        ...
        const zoomLevel = isMobile ? 8 : 9;
        mapRef.current.setView(selectedLocation.coordinates, zoomLevel, {
          animate: true,
          duration: 1,
        });
      }
    ...
    >
      ...
      <div
        ...
        style={{
          aspectRatio: "16/10",
          background:
            "linear-gradient(135deg, #0a0f1a 0%, #1a1f2e 50%, #0f1419 100%)",
      ...
      >
        ...
        <div
          style={{
            ...
            height: "clamp(20px, 5vw, 40px)",
            borderBottom:
              "clamp(2px, 0.4vw, 3px) solid rgba(34, 211, 238, 0.6)",
            borderLeft: "clamp(2px, 0.4vw, 3px) solid rgba(34, 211, 238, 0.6)",
          ...
          <div
            ...
            style={{
              ...
              border: `clamp(2px, 0.4vw, 3px) solid ${
                regionColors[selectedLocation.region]
              }`,
              borderRadius: "clamp(0.5rem, 1.5vw, 1rem)",
              padding: "clamp(0.75rem, 1.5vw, 1rem)",
              boxShadow: `
                0 20px 40px rgba(0,0,0,0.5),
                0 0 clamp(20px, 5vw, 40px) ${
                  regionColors[selectedLocation.region]
                }60
              `,
              zIndex: 20,
